...
const PaymentPage = ({ username }) => {
    ...
    const pay = async (amount) => {
        if (!currentUser?.razorpayid) {
            toast.error("Payment configuration not loaded. Please wait.");
            return;
        }
        // Get the order Id 
        ...
        var options = {
            ...
            "prefill": { //We recommend using the prefill parameter to auto-fill customer's contact information especially their phone number
                "name": "Drashti Soni", //your customer's name
                "email": "drashtisoni@gmail.com",
                "contact": "8799226657" //Provide the customer's phone number for better conversion rates 
            },
            "notes": {
